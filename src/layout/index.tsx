  ...
  return (
    ...
    <HeaderNavigation>
      ...
      <NavDesktop>
        <ul>
          <li>
            <strong><Link to="home" offset={-100}>Início</Link></strong>
          </li>

          <li>
            <strong><Link to="projects" offset={-50}>Projetos</Link></strong>
          </li>

          <li>
            <strong><Link to="about" offset={-50}>Sobre</Link></strong>
          </li>
        </ul>
      </NavDesktop>
      <NavMobile>
